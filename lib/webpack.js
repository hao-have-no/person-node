...
module.exports = class webpack{
    ...
    file(code){
        ...
        // otherRequire主要是替换require中的路径，替换为相对完整的路径
        //　相当于code中的require转化为了otherRequire,relativePath就是require传入的那个文件的路径,eg:./a.js
        // graph[module].dependencies[relativePath] 得到项目的路径
        const bundle = `(function(graph){
                function require(module){
                    function otherRequire(relativePath){
                        console.log(module,relativePath,graph[module],graph[module].dependencies[relativePath])
